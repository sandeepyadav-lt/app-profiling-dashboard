...
import styles from './MemoryUsageWidget.module.css';

const baseValues = memoryChartData.map((d) => d.value);
const labels = memoryChartData.map((d) => d.label);
  ...
  datasets: [
    {
      ...
      backgroundColor: withAlpha(chartColors.purple, 0.08),
      fill: true,
    },
  ],
};
...
export function MemoryUsageWidget({ instance, index }: WidgetInstanceProps) {
